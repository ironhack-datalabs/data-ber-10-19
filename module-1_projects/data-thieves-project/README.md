...
* Your project must include a database of your design created. You can host it in your local MySQL server, or in a cloud server (e.g. Google Cloud Platform, AWS) and a complete analysis of your data including the most meaningful insights you found.
